...
<div class="example">
    ...
    <div class="tab-content rounded-bottom">
        <form method="post" action="{{ url('item/update') }}">
            ...
            <input class="form-control" name="id" id="id" value="{{ $item->id }}" type="text">
            <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1022">
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-4">
                        <input class="form-control" name="name" id="name" value = "{{ $item->name }}" type="text">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label" for="inputPassword">Note</label>
                    <div class="col-sm-4">
                        <textarea class="form-control" name="note" id="note" rows="3">{{ $item->note }}</textarea>
                    </div>
                </div>
            </div>
