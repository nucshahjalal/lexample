...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-gears "></i><small> Manage Advanced Admission</small></h3>
            ...
            <div class="x_content">
                <div class="row">
                    <form method="get" action="{{ route('advanced-student.list') }}" accept-charset="UTF-8" class="form-horizontal">
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="item form-group">                             
                                <input class="form-control col-md-7 col-xs-12 " name="filter" id="filter"  value="{{ @$filter }}" placeholder="Search Advanced Admission..." type="text">
                                @error('filter')
            ...
            <div class="x_content">
                ...
                <ul class="nav nav-tabs bar_tabs">
                    <li class="nav-item">
                        <a href="{{ route('advanced-student.list') }}"  class="nav-link <?php if(isset($list)){ echo 'active'; }?>" ><i class="fa fa-list "></i> List</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('advanced-student.add') }}" class="nav-link <?php if(isset($add)){ echo 'active'; }?>" ><i class="fa fa-plus "></i> Add</a>
                    </li> 
                    <?php if(isset($edit)){ ?>
                        <li class="nav-item">
                ...
                <div class="tab-content"> 
                                        ...
                                        @forelse($students as $obj)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('advanced-student.edit', $obj->id) }}" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> Edit </a>
                                                    <form action="{{ route('advanced-student.delete', $obj->id) }}" method="POST">
                                                        @csrf
                                                        @method('delete')                                                        
                    ...
                    <div class="tab-pane fade active show">    
                        <div class="x_content big-form">
                            ...
                            <form method="post" action="{{ route('advanced-student.save') }}" accept-charset="UTF-8" id="form-add" enctype="multipart/form-data">
                               @csrf
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                    <div class="item form-group">
                                        ...
                                        <select class="form-control col-md-7 col-xs-12 " name="academic_year_id" id="academic_year_id" required="academic_year_id">
                                            <option value=""> --Select-- </option>
                                            @foreach($session_years as $obj)
                                            @php $running = $obj->is_running ? ' ['.'Running Year'.']' : '' @endphp
                                            <option value="{{ $obj->id }}" > {{ $obj->session_year }}{{$running}}</option>
                                            @endforeach                                            
                                        </select>
                    ...
                    <div class="tab-pane fade active show">    
                        <div class="x_content big-form">
                            ...
                            <form method="post" action="{{ route('advanced-student.update') }}" accept-charset="UTF-8" id="form-edit" enctype="multipart/form-data">
                                @csrf 
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                    <div class="item form-group">
                                        ...
                                        <select class="form-control col-md-7 col-xs-12 " name="academic_year_id" id="academic_year_id" required="academic_year_id">
                                            ...
                                            @foreach($session_years as $obj)
                                            @php $running = $obj->is_running ? ' ['.'Running Year'.']' : '' @endphp
                                            <option value="{{ $obj->id }}" @if($student->academic_year_id == $obj->id) selected ="selected" @endif > {{ $obj->session_year  }} {{$running}}</option>
                                            @endforeach                                             
                                        </select>
                                        <div class="help-block">
                                            @error('academic_year_id')
                        ...
                        <div class="form-group">
                            <div class="col-md-9 col-sm-9 offset-md-3">
                                <a href="{{ route('advanced-student.list') }}" class="btn btn-primary btn-sm">Cancel</a>
...
<script type="text/javascript">
    ...
    function get_student_modal(student_id){
        ...
        $.ajax({ 
          ...
          type   : "GET",
          url    : "/student/advanced-student/view/"+student_id,
...
<script type="text/javascript">
    ...
    function getClassBySection(){
        ...
        $.ajax({ 
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type   : "GET",
            url    : "/student/advanced-student/class_by_section",
